...
public class UpdatePetInTheStoreWithFormDataEndpointTests {
    @Autowired
    ...
    public void existingPetUpdatedSuccessfully() throws Throwable {
        ...
        Pet updatedPet = objectMapper.convertValue(petClient.findPetById(String.valueOf(generatedRandomPetId)).getBody(), Pet.class);
